    ...
    <head>
        ...
        <style>
            #preloader {
                ...
                height: 100%;
                z-index: 1999;
                background: #425162 url(/wp-content/uploads/misc/img/logo_hostel.png) no-repeat center center
            }
        ...
        <div id="modal_form"> <span id="modal_close">X</span>
            <div class="reserv">
                <form method="POST" action="<?php echo get_admin_url(1,'admin-post.php'); ?>">
                    ...
                    <input type="submit" value="<?=$modal_arr['modal_1_show_button']?>" class="reservation_submit"> </form> <img class="saleFiveImg" src="/wp-content/uploads/misc/img/hostel.png">
                <div class="saleFive">
