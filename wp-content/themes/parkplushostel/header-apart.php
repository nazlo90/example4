    ...
    <head>
        ...
        <style>
            #preloader {
                ...
                height: 100%;
                z-index: 1999;
                background: #425162 url('/wp-content/uploads/misc/img/logo_apart.png') no-repeat center center
            }
...
-->
        ...
        </nav><?php $temp_blog=get_current_blog_id(); switch_to_blog(1);  global $modal_arr;$modal_arr=PH_Get_Modals($post->ID); switch_to_blog($temp_blog);?>
        <div id="modal_form"> <span id="modal_close">X</span>
            <div class="reserv">
                <form method="POST" action="<?php echo get_admin_url(1,'admin-post.php'); ?>">
                        ...
                        <div class="input-daterange input-group datepicker">
                            ...
                            <label><?=$modal_arr['modal_1_reserv']?>
                                <select class="input-sm form-control" name="reserv_type">
                                    ...
                                    <option value="2" selected><?=$modal_arr['modal_1_select_2']?></option>
                                </select>
                            </label>
                        </div>
                    </div>
                    ...
                    <input type="submit" value="<?=$modal_arr['modal_1_show_button']?>" class="reservation_submit"> </form>

                <img class="saleFiveImg" src="/wp-content/uploads/misc/img/apart.png">
                <div class="saleFive">
...
if ((get_current_blog_id()==1)&&(is_front_page())) {
    ...
    if (get_current_blog_id()==1) echo get_metadata('post',WPML_HR(2,ICL_LANGUAGE_CODE),'header_address_line',true); 
    else
    { switch_to_blog(1);
