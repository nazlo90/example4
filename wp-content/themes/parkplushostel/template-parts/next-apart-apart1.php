                ...
                <div class="container">
                    <div class="row">
                        <?php   if (get_current_blog_id()==1) {
                            ...
                            if (!is_page(array(26,38,34)))
                                $temp=str_replace('logo.png','logo_hostel.png',$temp);
                            echo str_replace('<?php echo __tempurl__ ; ?>',__tempurl__,$temp);}

                        else
                        {   switch_to_blog(1);
                            $temp=get_metadata('post',WPML_HR(2,ICL_LANGUAGE_CODE),'menu_s',true);
                            $temp=str_replace('<?php echo __tempurl__ ; ?>',__tempurl__,$temp);
                            $temp=str_replace('logo.png','hostel.png',$temp);
                        ...
                        <div class="col-md-4 col-md-offset-2">
                            <div class="reserv">
                                <form method="post" action="<?php echo get_admin_url(1,'admin-post.php'); ?>">
                                    <h3></h3>
                                    <div class="sandbox-container"><? switch_to_blog(1);?>
                                        <div class="input-daterange input-group">
                                            <label><?=get_metadata('post',WPML_HR(2,ICL_LANGUAGE_CODE),'modal_1_data_zaizdu',true)?><input type="text" value="" class="input-sm form-control" name="start" readonly=""></label>
                                            <label><?=get_metadata('post',WPML_HR(2,ICL_LANGUAGE_CODE),'modal_1_data_vyizdu',true)?><input type="text" value="" class="input-sm form-control" name="end" readonly=""></label>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" value="<?=get_metadata('post',WPML_HR(2,ICL_LANGUAGE_CODE),'modal_1_reserv',true)?>" class="reservation_submit">
                                </form><? switch_to_blog(2);?>
                                <img class="saleFiveImg" src="<?php echo __tempurl__; ?>hostel.png">
...
<div></div>
<?php switch_to_blog($temp_blog_id);?>